                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control select2" name="name">
                                    <option value="Gelombang I" {{$data->name == 'Gelombang I' ? 'selected' : ''}} >Gelombang I</option>
                                    <option value="Gelombang II" {{$data->name == 'Gelombang II' ? 'selected' : ''}}>Gelombang II</option>
                                    <option value="Gelombang III"{{$data->name == 'Gelombang III' ? 'selected' : ''}}>Gelombang III</option>
                                </select>
                                @error('name')
                                    <p class="text-danger">
                                        {{ $message }}
