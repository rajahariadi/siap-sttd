                     ...
                     <div class="row align-items-center mb-5">
                         ...
                         <div class="col-md-6">
                             <div class="text-center">
                                 <span class="peity-pie" data-peity='{ "fill": ["#508aeb", "#f2f2f2"]}'
                                     data-width="84" data-height="84">6/8</span>
                             </div>
                         </div>
                     </div>
             ...
             <div class="card-body">
                 ...
                 <ul class="list-unstyled activity-list">
                     ...
                     <li class="activity-item">
                         ...
                         <div>
                             <a href="#" class="activity-item-img"><img src="admin/images/small/img-1.jpg"
                                     alt="" class="rounded mb-2"></a>
                             <a href="#" class="activity-item-img"><img src="admin/images/small/img-2.jpg"
                                     alt="" class="rounded mb-2"></a>
                         </div>
                     </li>
                     <li class="activity-item">
                         ...
                         <p class="text-muted mt-2 mb-4">The new common language will be more simple and
                             regular their pronunciation.</p>
                         <div>
