        ...
        <div class="container-fluid">
            ...
            <div class="logo">
                ...
                <a href="index.html" class="logo">
                    <img src="admin/images/logo-sm.png" alt="" height="32" class="logo-small">
                    <img src="admin/images/logo.png" alt="" height="20" class="logo-large">
                </a>
                ...
                <ul class="list-inline float-right mb-0">
                        ...
                        <div
                            ...
                            <div class="slimscroll" style="max-height: 230px;">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon"><img src="admin/images/users/user-2.jpg" alt="user-img"
                                ...
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon"><img src="admin/images/users/user-3.jpg" alt="user-img"
                                            class="img-fluid rounded-circle" /> </div>
                                ...
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon"><img src="admin/images/users/user-4.jpg" alt="user-img"
                                            class="img-fluid rounded-circle" /> </div>
                                ...
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon"><img src="admin/images/users/user-5.jpg" alt="user-img"
                                            class="img-fluid rounded-circle" /> </div>
                                ...
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon"><img src="admin/images/users/user-6.jpg" alt="user-img"
                                            class="img-fluid rounded-circle" /> </div>
                                    <p class="notify-details"><b>David M. Ryan</b><span class="text-muted">You have
                    ...
                    <li class="list-inline-item dropdown notification-list">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown ">
                            ...
                            <a class="dropdown-item text-danger" href="#"><i class="mdi mdi-logout m-r-5  text-danger"></i>
                                Logout</a>
                        </div>
